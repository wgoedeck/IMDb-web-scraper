...
These algorithms do not always work: one error, which I've now corrected, is that the movie's year of release may be off by a year, e.g., for *Sisters*, the Criterion Channel's year is *1973*, while the IMDb year is *1972*, which I've seen for some foreign films as well. For this error I've had the IMdB year search range extended to +/- of that of the Criterion Channel's year. Some other times the movie is not listed at the IMDb site; this usually happens again with foreign films, with unmatched movie titles, e.g., when one title may be in English and the other in the host language of the country the movie was made at. I've found this movie rating algorithm to be at least 90% effective with foreign movies, and nearly 100% when rating English language films. 
